...
exports.validateInput = (input) => {
  ...
  if (input[0].length !== 64) errors.push("Invalid private key provided");
  if (input[1].length !== 66) errors.push("Invalid TX Hash provided");
  if (!(input[2] !== "mainnet" || input[2] !== "testnet"))
